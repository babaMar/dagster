...
`pyproject.toml` file with `tool.dg.type = "workspace"` set in the root workspace directory.
"""


NOT_PROJECT_ERROR_MESSAGE = """
This command must be run inside a Dagster project directory. Ensure that the nearest
pyproject.toml has `tool.dg.type = "project"` set.
"""
...
nearest pyproject.toml has `tool.dg.type = "project"` or `tool.dg.type = "workspace"` set.
"""
