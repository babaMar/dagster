...
class DgContext:
    ...
    def for_workspace_environment(cls, path: Path, command_line_config: DgRawCliConfig) -> Self:
        context = cls.from_config_file_discovery_and_command_line_config(path, command_line_config)
    ...
    def for_workspace_or_project_environment(
        ...
        context = cls.from_config_file_discovery_and_command_line_config(path, commmand_line_config)
    ...
    @classmethod
    def from_config_file_discovery_and_command_line_config(
        cls,
        path: Path,
        ...
        workspace_config_path = discover_config_file(
            path, lambda x: bool(x.get("type") == "workspace")
        )
    ...
    def with_root_path(self, root_path: Path) -> Self:
        ...
        return self.__class__.from_config_file_discovery_and_command_line_config(
